...
from freelingo_agent.api.auth import router as auth_router
...
def main():
    """Main entry point for the freelingo command."""
    import uvicorn
    uvicorn.run("freelingo_agent.main:app", host="0.0.0.0", port=8000, reload=True)
