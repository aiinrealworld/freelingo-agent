...
from freelingo_agent.db.words import get_user_words, create_word, update_word, delete_word
...
async def delete_word_endpoint(word_id: str, current_user: User = Depends(get_current_user)):
    """Delete a word"""
    try:
