...
from freelingo_agent.services.user_session_service import get_session, clear_dialogue_in_session, update_dialogue_turn_in_session, store_agent_response_in_session
...
def test_transcript_construction():
    ...
    try:
        ...
        print(f"Transcript dict: {transcript.model_dump()}")
